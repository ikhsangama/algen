...
?>
  ...
  <div class="page-header" align="center">
	...
	<div class="row">
			<div class="col m4">
					<div class="row form-group">
						<div class="input-field col s12">
							<select id="asal" name="asal" class="" onchange="loadSama(); disablecheckbox(); LoadMarkerPeta();">
						...
						<label class="control-label" for="asal">Asal:</label>
					</div>
				</div>
				...
				<div class="">
					<label class="control-label" for="tujuan">Rute:</label>
					<form id="kunjungan">
					<table class="responsive-table">
						...
						if(mysqli_num_rows($query) <> 0){
							 ...
							 ?>
										<tr><td>
											<div class="checkbox">
											<input id="<?php echo $x?>" type="checkbox" value="<?php echo $data['id_lokasi'] ?>" onclick="LoadMarkerPeta();">
											<label for="<?php echo $x?>"><?php echo $data['nama']?></label>
										</div>
										</td>
									<?php
								}
			...
			<div class="col s12">
					<div class="row">
						<div id="map" class="gmap col s12"></div>
					</div>
