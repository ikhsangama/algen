...
?>
  ...
  <div class="page-header" align="center">
    <h2>Simulasi Pencarian Rute Terpendek Pengantaran Dokumen Universitas Diponegoro</h2>
  </div>
  <div class="row">
  	<div class="col-md-12">
  		<a href="admin.php"><button type="button" class="btn btn-success pull-right"><i class="glyphicon glyphicon-user"></i> <span>Login Admin</span></button></a>
  	</div>
  </div>
  <div class="row">
	  	<div class="col-md-4">
	  			<div class="row form-group">
	  				<label class="control-label col-md-2" for="asal">Titik Asal:</label>
	  				<div class="col-md-10">
				...
				<div class="row form-group">
					<label class="control-label col-md-2" for="tujuan">Titik Akhir:</label>
					<div class="col-md-10">
				...
				<div class="table-responsive">
				    ...
				    if(mysqli_num_rows($query) <> 0){
				       ...
				       ?>
				        		<tr><td>
				        			<div class="checkbox">
				        			<span title="<?php echo $data['nama']?>"><label><input id="<?php echo $x?>" type="checkbox" value="<?php echo $data['id_lokasi'] ?>" onclick="LoadMarkerPeta();"> <?php echo $data['id_lokasi'] ?></label></span>
				        			</div>
				        		</td>
				        	<?php
				        }
				...
				<div class="form-group">
    				<div class="col-md-offset-3 col-sm-6 col-md-6">
						<input type="submit" class="btn btn-block btn-custom-green" value="Proses" id="prosesalgen" onclick="kirimdata(); onPageLoad();" /> <br>
					</div>
				</div>
